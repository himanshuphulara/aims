...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <x-bar-after-top-bar title="{{ $title }}" button="" count="{{ count($nivs) }}" target="addniv" currentmonth=""/>
            <!-- start page title -->
            {{-- <div class="row">
                <div class="col-6">
                        ...
                        <div class="card-body">
                            <div class="table-responsive table-card">
                                <table  class="table table-bordered table-hover table-nowrap align-middle mb-0" id="mytab">
                                    ...
                                    <tbody>
                                        @forelse ($nivs as $niv)
                                        @php $nivdata = \App\Models\Items::where('parent_item_id',$niv->id)->where('property_type','nivs')->get();
    ...
    $('#niv-form').on('submit', function(event) {
        ...
        var tableData = [];
                $('#myTable tbody tr').each(function() {
                    ...
                    tableData.push({ items:items,au:au,date:date,qty:qty,remarks:remarks });
                });
