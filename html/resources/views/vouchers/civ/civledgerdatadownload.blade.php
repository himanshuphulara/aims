<style>
    ...
    <div class="container">
    <h3 class="text-align-center">CIV LEDGER FROM </h3>
    <h3 class="text-align-center">{{ $start }} - {{ $end }} </h3>
    <table border=1>
            <tr>
                <td class="text-align-center" data-column-id="date">S.No.</td>
                <td class="text-align-center" data-column-id="lpno">LPNO</td>
        ...
        <tbody>
            ...
            @forelse ($civledger as $civ)
                <tr>
                    ...
                    <td class="text-align-center">{{ $civ['lpno'] }}</td>
                    <td class="text-align-center">{{ $civ['items'] }}</td>
                    <td class="text-align-center">{{ $civ['date'] }}</td>
                    <td class="text-align-center">{{ $civ['qty'] }}</td>
                    <td class="text-align-center">{{ $civ['remarks'] }}</td>
                </tr>      
            @empty
