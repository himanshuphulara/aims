...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <x-bar-after-top-bar title="{{ $title }}" button="" count="{{ count($crvs) }}" target="addcrv" currentmonth=""/>
            <!-- start page title -->
            {{-- <div class="row">
                <div class="col-6">
                        ...
                        <div class="card-body">
                            <div class="table-responsive table-card">
                                <table  class="table table-bordered table-hover table-nowrap align-middle mb-0" id="mytab">
                                    ...
                                    <tbody>
                                        @forelse ($crvs as $crv)
                                        @php $crvdata = \App\Models\Items::where('parent_item_id',$crv->id)->where('property_type','crvs')->get(); 
                                        ...
                                        @empty
                                        <tr class="text-center"><td colspan="25">No CRV Founds</td></tr>
                                        @endforelse
                                    </tbody>
                                </table>
