...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/js/table/dataTables.min.css')}}" rel="stylesheet" type="text/css">
    <!-- Icons Css -->
            ...
            <div class="d-flex align-items-center">
                ...
                {{-- <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-primary rounded-circle" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="position-absolute topbar-badge fs-9 translate-middle badge rounded-pill bg-danger">{{ count(auth()->user()->notifications) }}<span class="visually-hidden">unread messages</span></span>
                    </button>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-1">
                                                <a href="#!" class="stretched-link">
                                                    <h6 class="mt-0 fs-12 mb-2 ">
                                                        {{ $notify->data['fund_type'] }} {{ $notify->data['message'] }}
                                                    </h6>
                                                </a>
                                                <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                    <span><i class="mdi mdi-clock-outline"></i>                                                   
                                                        {{ \App\Helpers\Helper::timeAgo($notify->created_at) }}                                                    
                                                    </span>
                                                </p>
                                            </div>
                                        </div>
                ...
                <div class="dropdown header-item">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{{ auth()->user()->profile_pic!=''?asset('storage/'.auth()->user()->profile_pic):asset('assets/images/users/user-img.jpg') }}" alt="{{ auth()->user()->name }}">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <a class="dropdown-item" href="{{ route('userprofile') }}"><i class="bx bx-user fs-15 align-middle me-1"></i> <span key="t-profile">Profile</span></a>
